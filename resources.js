...
Blockly4kids.gameImages['Background'] = [
	...
	[{ src: 'assets/img/Background/bg_wood.png', width: 50, height: 50 }, 'Background-bg-wood#assets/img/Background/bg_wood.png'],
...
Blockly4kids.gameImages['ShootingGallery'] = [
	[{ src: 'assets/img/ShootingGallery/crosshair_blue_large.png', width: 50, height: 50 }, 'ShootingGallery-crosshair-blue-large#assets/img/ShootingGallery/crosshair_blue_large.png'],
	[{ src: 'assets/img/ShootingGallery/crosshair_blue_small.png', width: 50, height: 50 }, 'ShootingGallery-crosshair-blue-small#assets/img/ShootingGallery/crosshair_blue_small.png'],
	[{ src: 'assets/img/ShootingGallery/crosshair_outline_large.png', width: 50, height: 50 }, 'ShootingGallery-crosshair-outline-large#assets/img/ShootingGallery/crosshair_outline_large.png'],
	[{ src: 'assets/img/ShootingGallery/crosshair_outline_small.png', width: 50, height: 50 }, 'ShootingGallery-crosshair-outline-small#assets/img/ShootingGallery/crosshair_outline_small.png'],
	[{ src: 'assets/img/ShootingGallery/crosshair_red_large.png', width: 50, height: 50 }, 'ShootingGallery-crosshair-red-large#assets/img/ShootingGallery/crosshair_red_large.png'],
	[{ src: 'assets/img/ShootingGallery/crosshair_red_small.png', width: 50, height: 50 }, 'ShootingGallery-crosshair-red-small#assets/img/ShootingGallery/crosshair_red_small.png'],
	[{ src: 'assets/img/ShootingGallery/curtain.png', width: 50, height: 50 }, 'ShootingGallery-curtain#assets/img/ShootingGallery/curtain.png'],
	[{ src: 'assets/img/ShootingGallery/curtain_rope.png', width: 50, height: 50 }, 'ShootingGallery-curtain-rope#assets/img/ShootingGallery/curtain_rope.png'],
	[{ src: 'assets/img/ShootingGallery/curtain_straight.png', width: 50, height: 50 }, 'ShootingGallery-curtain-straight#assets/img/ShootingGallery/curtain_straight.png'],
	[{ src: 'assets/img/ShootingGallery/curtain_top.png', width: 50, height: 50 }, 'ShootingGallery-curtain-top#assets/img/ShootingGallery/curtain_top.png'],
	[{ src: 'assets/img/ShootingGallery/duck_outline_back.png', width: 50, height: 50 }, 'ShootingGallery-duck-outline-back#assets/img/ShootingGallery/duck_outline_back.png'],
	[{ src: 'assets/img/ShootingGallery/duck_outline_brown.png', width: 50, height: 50 }, 'ShootingGallery-duck-outline-brown#assets/img/ShootingGallery/duck_outline_brown.png'],
	[{ src: 'assets/img/ShootingGallery/duck_outline_target_brown.png', width: 50, height: 50 }, 'ShootingGallery-duck-outline-target-brown#assets/img/ShootingGallery/duck_outline_target_brown.png'],
	[{ src: 'assets/img/ShootingGallery/duck_outline_target_white.png', width: 50, height: 50 }, 'ShootingGallery-duck-outline-target-white#assets/img/ShootingGallery/duck_outline_target_white.png'],
	[{ src: 'assets/img/ShootingGallery/duck_outline_target_yellow.png', width: 50, height: 50 }, 'ShootingGallery-duck-outline-target-yellow#assets/img/ShootingGallery/duck_outline_target_yellow.png'],
	[{ src: 'assets/img/ShootingGallery/duck_outline_white.png', width: 50, height: 50 }, 'ShootingGallery-duck-outline-white#assets/img/ShootingGallery/duck_outline_white.png'],
	[{ src: 'assets/img/ShootingGallery/duck_outline_yellow.png', width: 50, height: 50 }, 'ShootingGallery-duck-outline-yellow#assets/img/ShootingGallery/duck_outline_yellow.png'],
	[{ src: 'assets/img/ShootingGallery/grass1.png', width: 50, height: 50 }, 'ShootingGallery-grass1#assets/img/ShootingGallery/grass1.png'],
	[{ src: 'assets/img/ShootingGallery/grass2.png', width: 50, height: 50 }, 'ShootingGallery-grass2#assets/img/ShootingGallery/grass2.png'],
	[{ src: 'assets/img/ShootingGallery/icon_bullet_gold_long.png', width: 50, height: 50 }, 'ShootingGallery-icon-bullet-gold-long#assets/img/ShootingGallery/icon_bullet_gold_long.png'],
	[{ src: 'assets/img/ShootingGallery/icon_bullet_gold_short.png', width: 50, height: 50 }, 'ShootingGallery-icon-bullet-gold-short#assets/img/ShootingGallery/icon_bullet_gold_short.png'],
	[{ src: 'assets/img/ShootingGallery/icon_bullet_silver_long.png', width: 50, height: 50 }, 'ShootingGallery-icon-bullet-silver-long#assets/img/ShootingGallery/icon_bullet_silver_long.png'],
	[{ src: 'assets/img/ShootingGallery/icon_bullet_silver_short.png', width: 50, height: 50 }, 'ShootingGallery-icon-bullet-silver-short#assets/img/ShootingGallery/icon_bullet_silver_short.png'],
	[{ src: 'assets/img/ShootingGallery/icon_duck.png', width: 50, height: 50 }, 'ShootingGallery-icon-duck#assets/img/ShootingGallery/icon_duck.png'],
	[{ src: 'assets/img/ShootingGallery/icon_target.png', width: 50, height: 50 }, 'ShootingGallery-icon-target#assets/img/ShootingGallery/icon_target.png'],
	[{ src: 'assets/img/ShootingGallery/rifle.png', width: 50, height: 50 }, 'ShootingGallery-rifle#assets/img/ShootingGallery/rifle.png'],
	[{ src: 'assets/img/ShootingGallery/rifle_red.png', width: 50, height: 50 }, 'ShootingGallery-rifle-red#assets/img/ShootingGallery/rifle_red.png'],
	[{ src: 'assets/img/ShootingGallery/shot_blue_large.png', width: 50, height: 50 }, 'ShootingGallery-shot-blue-large#assets/img/ShootingGallery/shot_blue_large.png'],
	[{ src: 'assets/img/ShootingGallery/shot_blue_small.png', width: 50, height: 50 }, 'ShootingGallery-shot-blue-small#assets/img/ShootingGallery/shot_blue_small.png'],
	[{ src: 'assets/img/ShootingGallery/stick_metal_outline.png', width: 50, height: 50 }, 'ShootingGallery-stick-metal-outline#assets/img/ShootingGallery/stick_metal_outline.png'],
	[{ src: 'assets/img/ShootingGallery/stick_metal_outline_broken.png', width: 50, height: 50 }, 'ShootingGallery-stick-metal-outline-broken#assets/img/ShootingGallery/stick_metal_outline_broken.png'],
	[{ src: 'assets/img/ShootingGallery/stick_woodFixed_outline.png', width: 50, height: 50 }, 'ShootingGallery-stick-woodFixed-outline#assets/img/ShootingGallery/stick_woodFixed_outline.png'],
	[{ src: 'assets/img/ShootingGallery/stick_wood_outline.png', width: 50, height: 50 }, 'ShootingGallery-stick-wood-outline#assets/img/ShootingGallery/stick_wood_outline.png'],
	[{ src: 'assets/img/ShootingGallery/stick_wood_outline_broken.png', width: 50, height: 50 }, 'ShootingGallery-stick-wood-outline-broken#assets/img/ShootingGallery/stick_wood_outline_broken.png'],
	[{ src: 'assets/img/ShootingGallery/target_colored_outline.png', width: 50, height: 50 }, 'ShootingGallery-target-colored-outline#assets/img/ShootingGallery/target_colored_outline.png'],
	[{ src: 'assets/img/ShootingGallery/target_red1_outline.png', width: 50, height: 50 }, 'ShootingGallery-target-red1-outline#assets/img/ShootingGallery/target_red1_outline.png'],
	[{ src: 'assets/img/ShootingGallery/target_red2_outline.png', width: 50, height: 50 }, 'ShootingGallery-target-red2-outline#assets/img/ShootingGallery/target_red2_outline.png'],
	[{ src: 'assets/img/ShootingGallery/text_gameover.png', width: 50, height: 50 }, 'ShootingGallery-text-gameover#assets/img/ShootingGallery/text_gameover.png'],
	[{ src: 'assets/img/ShootingGallery/text_go.png', width: 50, height: 50 }, 'ShootingGallery-text-go#assets/img/ShootingGallery/text_go.png'],
	[{ src: 'assets/img/ShootingGallery/text_ready.png', width: 50, height: 50 }, 'ShootingGallery-text-ready#assets/img/ShootingGallery/text_ready.png'],
	[{ src: 'assets/img/ShootingGallery/text_score.png', width: 50, height: 50 }, 'ShootingGallery-text-score#assets/img/ShootingGallery/text_score.png'],
	[{ src: 'assets/img/ShootingGallery/text_timeup.png', width: 50, height: 50 }, 'ShootingGallery-text-timeup#assets/img/ShootingGallery/text_timeup.png'],
	[{ src: 'assets/img/ShootingGallery/tree_oak.png', width: 50, height: 50 }, 'ShootingGallery-tree-oak#assets/img/ShootingGallery/tree_oak.png'],
	[{ src: 'assets/img/ShootingGallery/tree_pine.png', width: 50, height: 50 }, 'ShootingGallery-tree-pine#assets/img/ShootingGallery/tree_pine.png'],
	[{ src: 'assets/img/ShootingGallery/upcloud1.png', width: 50, height: 50 }, 'ShootingGallery-upcloud1#assets/img/ShootingGallery/upcloud1.png'],
	[{ src: 'assets/img/ShootingGallery/upcloud2.png', width: 50, height: 50 }, 'ShootingGallery-upcloud2#assets/img/ShootingGallery/upcloud2.png'],
	[{ src: 'assets/img/ShootingGallery/water1.png', width: 50, height: 50 }, 'ShootingGallery-water1#assets/img/ShootingGallery/water1.png'],
	[{ src: 'assets/img/ShootingGallery/water2.png', width: 50, height: 50 }, 'ShootingGallery-water2#assets/img/ShootingGallery/water2.png']
];
