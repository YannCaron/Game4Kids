...
Blockly.Msg.BLOCK_WINDOW_WIDTH = "window width";
Blockly.Msg.BLOCK_WINDOW_HEIGHT = "window height";
...
Blockly.Msg.BLOCK_SPEED = "speed";
Blockly.Msg.BLOCK_DISTANCE = "distance";
Blockly.Msg.BLOCK_IS_MOVING = "is moving";
Blockly.Msg.BLOCK_IS_WALKING = "is walking";
Blockly.Msg.BLOCK_IS_JUMPING = "is jumping";

Blockly.Msg.BLOCK_VELOCITY_FROM_ANGLE = "set velocity from angle";
...
Blockly.Msg.BLOCK_DISP_SIDEWAYS = "displace sideways";
...
Blockly.Msg.CAMERA_DELTA = "camera displacment in";
...
Blockly.Msg.TOOLTIP_ACTOR_SET_CUSTOM = "get the actor created property value.";
Blockly.Msg.TOOLTIP_ACTOR_SET = "set actor property value.\nproperties are:\n%1";
Blockly.Msg.TOOLTIP_ACTOR_SET_CUSTOM = "create a new actor property and set value to it.";
