...
Blockly.Msg.BLOCK_WINDOW_WIDTH = "largeur de la fenêtre";
Blockly.Msg.BLOCK_WINDOW_HEIGHT = "hauteur de la fenêtre";
...
Blockly.Msg.BLOCK_SET_GLOBAL = "fixer globale";
Blockly.Msg.BLOCK_TO_VALUE = "à";

Blockly.Msg.BLOCK_SECONDS = "seconds";

Blockly.Msg.BLOCK_OPACITY = 'opacité en %'
Blockly.Msg.BLOCK_VELOCITY = "velocité en %";
Blockly.Msg.BLOCK_ACCELERATION = "accélération";
...
Blockly.Msg.TOOLTIP_ACTOR_SET_CUSTOM = "obtient la valeur de la propriété nouvellement créée.";
Blockly.Msg.TOOLTIP_ACTOR_SET = "définit la valeur de la propriété de l'acteur.\nles propriétés sont :\n%1";
Blockly.Msg.TOOLTIP_ACTOR_SET_CUSTOM = "crée une nouvelle propriété à l'acteur et définit sa valeur.";
